...
{
    pub numUsageVgprs: u32, pub numUsedSgprs: u32, pub ldsSizePerLocalWorkGroup: u32,
    pub ldsUsageSizeInBytes: size_t, pub scratchMemUsageInBytes: size_t
}
#[repr(C)] #[derive(Clone, Debug, PartialEq, Eq)]
pub struct VkShaderStatisticsInfoAMD
{
    ...
    pub numPhysicalVgprs: u32, pub numPhysicalSgprs: u32,
    pub numAvailableVgprs: u32, pub numAvailableSgprs: u32,
    pub computeWorkGroupSize: [u32; 3]
}

pub type PFN_vkGetShaderInfoKHR = extern "system" fn(device: VkDevice, pipeline: VkPipeline,
...
extern "system"
{
    pub fn vkGetShaderInfoKHR(device: VkDevice, pipeline: VkPipeline, shaderStage: VkShaderStageFlags,
        infoType: VkShaderInfoTypeAMD, pInfoSize: *mut size_t, pInfo: *mut c_void) -> VkResult;
}
