...
pub const ELEMENTS: &[Element] = &[
    ...
    Element::Enum(Enum::extending(
        ...
        "BLEND_OP",
        &[
            Enum::member("ZERO", vk_ext_enum(149, 0) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("SRC", vk_ext_enum(149, 1) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("DST", vk_ext_enum(149, 2) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("SRC_OVER", vk_ext_enum(149, 3) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("DST_OVER", vk_ext_enum(149, 4) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("SRC_IN", vk_ext_enum(149, 5) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("DST_IN", vk_ext_enum(149, 6) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("SRC_OUT", vk_ext_enum(149, 7) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("DST_OUT", vk_ext_enum(149, 8) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("SRC_ATOP", vk_ext_enum(149, 9) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("DST_ATOP", vk_ext_enum(149, 10) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("XOR", vk_ext_enum(149, 11) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("MULTIPLY", vk_ext_enum(149, 12) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("SCREEN", vk_ext_enum(149, 13) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("OVERLAY", vk_ext_enum(149, 14) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("DARKEN", vk_ext_enum(149, 15) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("LIGHTEN", vk_ext_enum(149, 16) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("COLORDODGE", vk_ext_enum(149, 17) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("COLORBURN", vk_ext_enum(149, 18) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("HARDLIGHT", vk_ext_enum(149, 19) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("SOFTLIGHT", vk_ext_enum(149, 20) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("DIFFERENCE", vk_ext_enum(149, 21) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("EXCLUSION", vk_ext_enum(149, 22) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("INVERT", vk_ext_enum(149, 23) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("INVERT_RGB", vk_ext_enum(149, 24) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("LINEARDODGE", vk_ext_enum(149, 25) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("LINEARBURN", vk_ext_enum(149, 26) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("VIVIDLIGHT", vk_ext_enum(149, 27) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("LINEARLIGHT", vk_ext_enum(149, 28) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("PINLIGHT", vk_ext_enum(149, 29) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("HARDMIX", vk_ext_enum(149, 30) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("HSL_HUE", vk_ext_enum(149, 31) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("HSL_SATURATION", vk_ext_enum(149, 32) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("HSL_COLOR", vk_ext_enum(149, 33) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("HSL_LUMINOSITY", vk_ext_enum(149, 34) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("PLUS", vk_ext_enum(149, 35) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("PLUS_CLAMPED", vk_ext_enum(149, 36) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("PLUS_CLAMPED_ALHPA", vk_ext_enum(149, 37) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("PLUS_DARKER", vk_ext_enum(149, 38) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("MINUS", vk_ext_enum(149, 39) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("MINUS_CLAMPED", vk_ext_enum(149, 40) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("CONTRAST", vk_ext_enum(149, 41) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("INVERT_OVG", vk_ext_enum(149, 42) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("RED", vk_ext_enum(149, 43) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("GREEN", vk_ext_enum(149, 44) as _).extension("blend_operation_advanced", "EXT"),
            Enum::member("BLUE", vk_ext_enum(149, 45) as _).extension("blend_operation_advanced", "EXT"),
        ],
    )),
    Element::Enum(
        Enum::new(
            ...
            "BLEND_OVERLAP",
            &[
                Enum::member("UNCORRELATED", 0).extension("blend_operation_advanced", "EXT"),
                Enum::member("DISJOINT", 1).extension("blend_operation_advanced", "EXT"),
                Enum::member("CONJOINT", 2).extension("blend_operation_advanced", "EXT"),
            ],
        )
        .extension("blend_operation_advanced", "EXT"),
    ),
    Element::Enum(
        Enum::new(
            "ValidationCacheHeaderVersion",
            "VALIDATION_CACHE_HEADER_VERSION",
            &[Enum::member("ONE", 1).extension("validation_cache", "EXT")],
        )
        .extension("validation_cache", "EXT"),
    ),
    Element::Enum(
        Enum::new(
            "ValidationCheck",
            "VALIDATION_CHECK",
            &[
                Enum::member("ALL", 0).extension("validation_flags", "EXT"),
                Enum::member("SHADERS", 1).extension("validation_flags", "EXT"),
            ],
        )
        .extension("validation_flags", "EXT"),
    ),
    Element::Struct(
        Struct::new(
    ...
    Element::Enum(
        Enum::new(
            ...
            "LAYER_SETTING_TYPE",
            &[
                Enum::member("BOOL32", 0).extension("layer_settings", "EXT"),
                Enum::member("INT32", 1).extension("layer_settings", "EXT"),
                Enum::member("INT64", 2).extension("layer_settings", "EXT"),
                Enum::member("UINT32", 3).extension("layer_settings", "EXT"),
                Enum::member("UINT64", 4).extension("layer_settings", "EXT"),
                Enum::member("FLOAT32", 5).extension("layer_settings", "EXT"),
                Enum::member("FLOAT64", 6).extension("layer_settings", "EXT"),
                Enum::member("STRING", 7).extension("layer_settings", "EXT"),
            ],
        )
        .extension("layer_settings", "EXT"),
    ),
    Element::Struct(
        Struct::new(
            "LayerSetting",
    ...
    Element::Enum(
        Enum::new(
            ...
            &[
                Enum::member("NONE", 0).extension("framebuffer_mixed_samples", "NV"),
                Enum::member("RGB", 1).extension("framebuffer_mixed_samples", "NV"),
                Enum::member("ALPHA", 2).extension("framebuffer_mixed_samples", "NV"),
                Enum::member("RGBA", 3).extension("framebuffer_mixed_samples", "NV"),
            ],
        )
    ...
    Element::Enum(
        Enum::new(
            ...
            &[
                Enum::member("LOW", 128).extension("global_priority", "EXT"),
                Enum::member("MEDIUM", 256).extension("global_priority", "EXT"),
                Enum::member("HIGH", 512).extension("global_priority", "EXT"),
                Enum::member("REALTIME", 1024).extension("global_priority", "EXT"),
            ],
        )
