...
# send!
PAYLOAD="{$PAYLOAD_STATUS_HEADER, \"build_url\": \"$BUILD_URL\", \"number\": $GITHUB_RUN_NUMBER, \"duration\": $BUILD_TIME_SECS, \"repository\": \"$GITHUB_REPOSITORY\", \"branch_name\": \"$GITHUB_REF\", \"commit\": $COMMIT_INFO}"
